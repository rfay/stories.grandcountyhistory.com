...
class Extension extends VersionedClass {
  ...
  /**
   * A serialized array containing information from the module's .info file.
   *
   * @var array
   */
  public $info;
  ...
  /**
   * Comments in an extension info file.
   *
   * @var array
   */
  ...
  /**
   * The module's database schema version number.
   *
   * @var string
   */
  ...
  /**
   * The path of the primary file for this item, relative to the Drupal root.
   *
   * @var string
   */
  public $filename;
  ...
  public function __construct($name, $extension) {
    ...
    $this->schema_version = $extension->schema_version;
    $this->filename = $extension->filename;
  ...
  public static function create($name, $extension) {
    return static::createVersionedInstance(array($name, $extension));
  }
   ...
   *   Comments.
   */
  protected function parseInfoComments() {
